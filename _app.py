...
PageLogo = Image.open("/Users/apple/Desktop/DSA/python/week/python_week_8_CS_Nisa//logo.png") 
DataSCPNG = Image.open("/Users/apple/Desktop/DSA/python/week/python_week_8_CS_Nisa//homepage.jpg")

st.set_page_config(layout = "wide",
                    page_title = "Python_week8_CS, Machine Learning Application",
                    page_icon = PageLogo)

st.image(DataSCPNG, use_column_width = True)
st.title("Water Portability and Long prediction datas")
st.sidebar.title("Pages")
page=st.sidebar.selectbox('Select',('Homepage','Data Preparation','Modeling'))
st.write('\n\n\n')

# Homepage -
if page == 'Homepage':
    data_choice = st.selectbox('Select data',('Water potability','Loan prediction'))

    if data_choice == 'Water potability':
        df = pd.read_csv("/Users/apple/Desktop/DSA/python/week/python_week_8_CS_Nisa//water_potability.csv")
    else:
        df = pd.read_csv("/Users/apple/Desktop/DSA/python/week/python_week_8_CS_Nisa//loan_pred.csv")
    ...
    st.markdown('Balance of values')
    st.write(pd.DataFrame(df.iloc[:, -1].value_counts()))

    st.markdown('Corrolation')
...
# Data Preparation
    ...
    with cl1:
        ...
        cat_fillna_options = st.radio(
            'Choose methods to fill null values:',
